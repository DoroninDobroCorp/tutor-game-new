...
exports.generateMathProblem = exports.generateStory = void 0;
const openai_1 = __importDefault(require("openai"));
const env_1 = require("../config/env");
const openai = new openai_1.default({
    apiKey: env_1.config.openaiApiKey,
});
const generateStory = async (prompt, studentLevel) => {
    try {
...
const generateMathProblem = async (topic, difficulty) => {
    try {
        const completion = await openai.chat.completions.create({
            model: 'gpt-4',
            messages: [
...
exports.generateMathProblem = generateMathProblem;
