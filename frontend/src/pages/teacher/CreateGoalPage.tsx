      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div>
          ...
          {errors.studentId && (
            <p className="mt-1 text-sm text-red-600">
              {t("createGoal.selectStudentError")}
            </p>
          )}
        </div>
        <div>
        ...
        <div>
          <label
            ...
            className="block text-sm font-medium text-gray-700"
          >
            {t("createGoal.illustrationStyle")}
          </label>
          <select
          ...
          >
            <option value="ILLUSTRATION">
              {t("createGoal.illustrationStandard")}
            </option>
            <option value="ANIME">{t("createGoal.anime")}</option>
          </select>
          {errors.illustrationStyle && (
            <p className="mt-1 text-sm text-red-600">
              {t("createGoal.illustrationStyleError")}
            </p>
          )}
        </div>
        <button
        ...
        >
          {isCreating
            ? t("createGoal.creating")
            : t("createGoal.createAndGoToPlan")}
        </button>
        {!students?.length && (
