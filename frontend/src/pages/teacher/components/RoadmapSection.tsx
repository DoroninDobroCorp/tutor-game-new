...
export const RoadmapSection = ({
  ...
  const regularLessons = section.lessons.filter(
    (l) => l.type !== "CONTROL_WORK",
  );
  const controlWorkLessons = section.lessons.filter(
    (l) => l.type === "CONTROL_WORK",
  );
        ...
        >
            ...
            <div className="flex items-center flex-grow min-w-0">
              ...
              {editingSectionIndex === sectionIndex ? (
                <input
                  ...
                  value={section.title}
                  onChange={(e) =>
                    onSectionTitleChange(e.target.value, sectionIndex)
                  }
                  onBlur={() => setEditingSectionIndex(null)}
                  onKeyDown={(e) =>
                    e.key === "Enter" && setEditingSectionIndex(null)
                  }
                  autoFocus
                ...
                >
                  ...
                  <h2 className="text-xl font-semibold cursor-pointer truncate">
                    {section.title}
                  </h2>
                </div>
              )}
            ...
            {(provided) => (
              ...
              >
                {regularLessons.map((lesson, lessonIndex) => {
                  ...
                  const originalLessonIndex = section.lessons.findIndex(
                    (l) => l.id === lesson.id,
                  );
                      ...
                      {(provided) => (
                        ...
                        >
                          ...
                          <div className="ml-2 flex-grow min-w-0">
                            {editingTitle.section === sectionIndex &&
                            editingTitle.lesson === originalLessonIndex ? (
                              <input
                                type="text"
                                value={lesson.title}
                                onChange={(e) =>
                          ...
                          <span
                            ...
                            title={
                              isNewLesson
                                ? t("roadmapSection.savePlanFirst")
                                : undefined
                            }
                          >
                            <button
                              ...
                              title={
                                !isNewLesson
                                  ? t("roadmapSection.configureContent")
                                  : undefined
                              }
                            >
                              <FiSettings />
                          ...
                          <button
                            onClick={() =>
                              onRemoveLesson(sectionIndex, originalLessonIndex)
                            }
                            className="ml-2 text-red-500 hover:text-red-700 opacity-0 group-hover:opacity-100 transition-opacity"
                            title={t("roadmapSection.removeLesson")}
                          >
                            <FiTrash2 size={14} />
                          </button>
                        </li>
          ...
          {controlWorkLessons.map((cw) => {
            ...
            return (
              <div
                key={cw.id}
                className="mt-4 pt-4 border-t-2 border-dashed border-amber-300"
              >
                <div className="flex items-center bg-amber-50 p-2 rounded-md border border-amber-200">
                  ...
                  <div className="ml-2 flex-grow min-w-0">
                    ...
                    editingTitle.lesson === originalLessonIndex ? (
                      ...
                      <div
                        ...
                        onClick={() =>
                          startEditing(sectionIndex, originalLessonIndex)
                        }
                      >
                        <button
                          className="mr-2 text-amber-600 hover:text-amber-700 opacity-0 group-hover:opacity-100 transition-opacity"
                          title={t("roadmapSection.editTitle")}
                        >
                          <FiEdit2 size={14} />
                        </button>
                        <span className="font-semibold truncate text-amber-800 cursor-pointer">
                          {cw.title}
                        </span>
                      </div>
                    )}
                  ...
                  <span className="relative ml-4">
                    <button
                      onClick={() =>
                        onEditLesson(cw, sectionIndex, originalLessonIndex)
                      }
                      className="text-gray-500 hover:text-amber-800"
                      title={t("roadmapSection.configureControlWork")}
                    >
                      <FiSettings />
                    </button>
                  </span>
                  <button
                    ...
                    title={t("roadmapSection.removeControlWork")}
                  >
                    <FiTrash2 size={14} />
                  </button>
                </div>
