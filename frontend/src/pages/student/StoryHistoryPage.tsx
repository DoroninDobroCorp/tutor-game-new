...
const StoryHistoryPage = () => {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useGetStoryHistoryQuery(goalId!, {
    skip: !goalId,
  });
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start mb-6">
                  {chapter.teacherSnippetImageUrl && (
                    <img
                      ...
                      alt={t("storyHistory.chapterIllustration", {
                        number: index + 1,
                      })}
